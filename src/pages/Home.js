...
import HomeContainer from '@C/Home/Homecontainer';
import ClassifyContainer from '@C/classify/Classifycontainer';
import CarContainer from '@C/car/carcontainer';
...
class Footer extends Component {
  ...
  componentDidUpdate (props, {selectedTab}) {
    ...
    let stab = this.state.selectedTab
    if ( stab=='blueTab') {
